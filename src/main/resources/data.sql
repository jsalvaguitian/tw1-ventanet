...
-- =====================================================
INSERT INTO Usuario (
    id, nombre, apellido, username, email, password, telefono, direccion, fechaCreacion, rol, activo, estado
) VALUES (
    1, 'Admin', 'Principal', 'admin', 'admin@email.com', '$2a$10$9rO6fX2qRUcVOYB7R7/B/uFvI6NoRp1L7wUcFHunCqTD0s9gJ5wKq', '1234567890', 'Av. Principal 1', CURRENT_DATE, 'ADMIN', true, 'ACTIVO'
);
...
INSERT INTO Usuario (
    ...
    2, 'Juan', 'Pérez', 'cliente1', 'juan.perez@email.com', '$2a$10$9rO6fX2qRUcVOYB7R7/B/uFvI6NoRp1L7wUcFHunCqTD0s9gJ5wKq', '111222333', 'Calle Falsa 123', CURRENT_DATE, 'CLIENTE', true, 'ACTIVO'
);
...
INSERT INTO Usuario (
    ...
    3, 'Pedro', 'Gómez', 'proveedor1', 'pedro.gomez@email.com', '$2a$10$9rO6fX2qRUcVOYB7R7/B/uFvI6NoRp1L7wUcFHunCqTD0s9gJ5wKq', '444555666', 'Calle Empresa 45', CURRENT_DATE, 'PROVEEDOR', true, 'ACTIVO'  
);

INSERT INTO Proveedor (
    id, razonsocial, cuit, rubro, sitioWeb, documento
) VALUES (
    3, 'Gómez Servicios S.A.', '30123456789', null , 'https://www.gomezservicios.com', "/docs/p0.pdf"
);
...
INSERT INTO Usuario (id, nombre, apellido, username, email, password, telefono, direccion, fechaCreacion, rol, activo, estado) VALUES
(4, 'Homero', 'Simpson', 'proveedor2', 'homero.simpson@email.com', '$2a$10$9rO6fX2qRUcVOYB7R7/B/uFvI6NoRp1L7wUcFHunCqTD0s9gJ5wKq', '444555666', 'Calle Siempre Viva 145', CURRENT_DATE, 'PROVEEDOR', true, 'ACTIVO'),
(5, 'Pedro', 'Simpson', 'proveedor3', 'pedro.simpson@email.com', '$2a$10$9rO6fX2qRUcVOYB7R7/B/uFvI6NoRp1L7wUcFHunCqTD0s9gJ5wKq', '444555666', 'Calle Cordoba 245', CURRENT_DATE, 'PROVEEDOR', true, 'ACTIVO'),
(6, 'Juan', 'Fulano', 'proveedor4', 'juan.fulano@email.com', '$2a$10$9rO6fX2qRUcVOYB7R7/B/uFvI6NoRp1L7wUcFHunCqTD0s9gJ5wKq', '444555666', 'Calle Santa fe 2245', CURRENT_DATE, 'PROVEEDOR', true, 'ACTIVO');    

INSERT INTO Proveedor (id, razonSocial, cuit, rubro, sitioWeb, documento, ubicacion, latitud, longitud) VALUES
(4, 'Obra Uno SRL', '20123456781', 'MATERIALES_OBRA', 'http://p1.com', '/docs/p1.pdf', 'Buenos Aires', -34.60, -58.38),
(5, 'Illumination Dos S.A.', '20876543219', 'ELECTRICIDAD_ILUMINACION', 'http://p2.com', '/docs/p2.pdf', 'Córdoba', -31.41, -64.18),
(6, 'Proveedor Tres SRL', '20112233445', 'PINTURAS_ACABADOS', 'http://p3.com', '/docs/p3.pdf', 'Rosario', -32.95, -60.66);
