...
INSERT INTO Proveedor (
    id, razonsocial, cuit, rubro, sitioWeb, estado, documento, ubicacion, latitud, longitud
) VALUES (3, 'Gómez Servicios S.A.', '30123456789', null , 'https://www.gomezservicios.com', 'PENDIENTE', null,'Buenos Aires', -34.60, -58.38);
...
INSERT INTO Producto (id, nombre, precio, descripcion, imagenUrl, stock, proveedor_id, tipo_producto_id, marca_id, presentacion_id, modelo, aceptaEnvio)
VALUES
...
(4, 'Puerta de Madera', 14500.00, 'Puerta igual pero de otro proveedor', '/uploads/imagenes/puerta-madera.jpg', 10, 3, 1, 1, 1, 'PMA-01', true),
(5, 'Ventana de Aluminio', 12000.00, 'Ventana igual de otro proveedor', '/uploads/imagenes/ventana-aluminio-2.jpg', 25, 3, 2, 2, 2, 'VAL-01', true),
(6, 'Pintura blanca', 5000.00, 'Pintura para interiores', '/uploads/imagenes/pintura-blanca.jpg', 40, 3, 3, 2, 2, 'PIN-BL', true),
(7, 'Puerta de PVC', 17000.00, 'Puerta plástica económica', '/uploads/imagenes/puerta-pvc.jpeg', 20, 3, 1, 3, 1, 'PVP-02', true),
